...
Atividade: TP03 - FormPessoa Versão 03 (JRadioButton)
Dupla: Gustavo Cerqueira Murai e Igor Cerqueira Murai
------------------------------------------------------------

ENUNCIADO:
Refaça o exercício anterior (FormPessoa), porém agora o campo "Sexo" deve ser
escolhido através de componentes do tipo JRadioButton ("M" ou "F").
...
public class FormPessoaV3 extends JFrame {
    ...
    public FormPessoaV3() {
        super("FormPessoa V3 (JRadioButton Sexo)");
        ...
        JPanel sexoPanel = new JPanel(new FlowLayout(FlowLayout.LEFT, 8, 0));
        ...
        btnOk.addActionListener(e -> {
            try {
                ...
                if (nome.isEmpty() || idadeStr.isEmpty() || (!rbM.isSelected() && !rbF.isSelected())) {
                    throw new IllegalArgumentException("Preencha Nome, selecione Sexo e informe Idade.");
                }
